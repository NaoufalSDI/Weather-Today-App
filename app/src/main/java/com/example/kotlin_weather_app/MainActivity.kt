...
class MainActivity : AppCompatActivity() {
    ...
    private val _openWeatherMapApiAky = "4f05c2cb23d0e18fdb4476d5fe9a3b2c"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        installSplashScreen().apply {
            // Keep the splash screen visible until weather data is loaded and permissions are granted
            setKeepOnScreenCondition {
                !::weatherResponse.isInitialized ||
                        !::airQualityResponse.isInitialized ||
                        !::currentWeatherResponse.isInitialized ||
            ...
            setOnExitAnimationListener { splashScreenView ->
                if (isLocationPermissionGranted()) {
                    ...
                    if (weatherResponse.length() > 0 &&
                        ...
                        showErrorDialog("Network Error", "No internet connection. Please check your connection and try again.")
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == _permissionAccessFineLocation) {
            if ((grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED)) {
                Toast.makeText(this, "Permission granted successfully. Wait to load weather data", Toast.LENGTH_SHORT).show()
                getCurrentLocation() // Fetch location data
            } else {
                Toast.makeText(this, "Permission denied. Please grant the location permission.", Toast.LENGTH_SHORT).show()
                showPermissionDeniedDialog() // Show alert dialog
            }
        }
    }
    ...
    private fun showErrorDialog(title: String, message: String) {
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("Retry") { _, _ ->
                getCurrentLocation() // Retry logic
            }
    ...
    private fun showPermissionDeniedDialog() {
        AlertDialog.Builder(this)
            ...
            .setMessage("Location permission is needed to fetch weather data. Please grant it.")
    ...
    private fun getCurrentLocation() {
        if (isGpsEnabled()) {
            ...
            getLocationViaDataStore() // Use fallback location
        }
    }
